...
public class ShopiFy  extends BaseTest {
    ...
    public void CreateOrder() throws InterruptedException, InterruptedIOException {
       WebDriverWait wait = new WebDriverWait(driver, 10);
        ...
        //wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//aside[@id='AppFrameAside']/div[2]/div[2]/div/div/nav/ul/li[2]/a/span")))).click();
        ...
        WebElement myDynamicElement = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//form/div[1]/div/div[1]/div/div/div[2]/div/div[3]/div/button[2]")));
